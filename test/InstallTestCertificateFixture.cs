...
{
	public class InstallTestCertificateFixture : IDisposable
	{
		public InstallTestCertificateFixture()
		{
			using (var store = new X509Store(StoreName.My, StoreLocation.CurrentUser, OpenFlags.ReadWrite))
			{
				using (var cert = new X509Certificate2(TestCertificateValues.Path, TestCertificateValues.Password,
